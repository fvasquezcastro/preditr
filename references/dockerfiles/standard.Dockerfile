# GENERATED by references/build_reference_image.sh (representative: rat/rn7).
# Canonical STANDARD reference recipe (standardChromOnly defaults to TRUE).
# Used by organisms whose species has a GenomeInfoDb UCSC seqlevels-style entry:
#   human, mouse, yeast, rat, fruitfly, celegans.
