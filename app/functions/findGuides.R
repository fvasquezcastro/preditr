findGuides <- function(cds_coordinates, genome, txdb, editor, codon_absolute_locations, 
  ...
  guides <- findSpacers(all_coordinates, 
                        bsgenome = genome,
  ...
  pam_ranges <- calculatePAMRange(target_aa, editor, edit_type, codon_absolute_locations, codon_seq, strand)
